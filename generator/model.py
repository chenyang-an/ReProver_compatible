...
class RetrievalAugmentedGenerator(TacticGenerator, pl.LightningModule):
    def __init__(
        ...
        eval_num_retrieved: Optional[int] = 1,
        eval_num_cpus: Optional[int] = 1,
        eval_num_theorems: Optional[int] = 1,
        ...
        self.generator = T5ForConditionalGeneration.from_pretrained("/home/chenyang/atp_guess_before/byt5_models/model_test_9")
